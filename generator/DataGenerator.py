...
class DataGenerator:
    ...
    def __init__(self, **kwargs):
        default_params = {
            ...
            'maxPositiveAreaForGenerator': 0.05,
            # Use generator if positiveArea < maxPositiveAreaForGenerator (% of tile)
        ...
        if (isinstance(self.gamodel, str)):
            self.gamodel = tf.keras.models.load_model(self.gamodel, compile=False,
